...
> ## ⚠️ セキュリティ注意
>
> **このツールはローカル/信頼できるネットワーク専用です。**
>
> - VPN・ファイアウォール・認証プロキシなしでの**公開インターネットへの露出は禁止**
> - 認証機能は内蔵していません — ネットワークにアクセスできる人なら誰でも使用可能
> - リモートアクセスには VPN または SSH トンネルを使用してください
...
- **systemd 連携** - systemd 管理外で起動した場合に警告を表示
